...
enum AppTemplate: CaseIterable {
    ...
    var item: Template.Item {
        ...
        case .testTarget:
            return .file(path: .appTestPath + "/Sources/\(appName)Tests.swift", templatePath: "Test.stencil")
        }
    }
}
...
extension String {
    ...
    static var appTestPath: Self {
        return "Projects/App/\(appName)/\(appName)Tests"
    }
}
